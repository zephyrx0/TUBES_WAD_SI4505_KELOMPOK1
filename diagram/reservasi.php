...
<!-- seksi 1 -->
    <section id="seksi1">
        <div class="container">
            ...
            <h1 class="fw-bold text-white">Halo, <?= $_SESSION["username"];?></h1>
...
<!-- seksi 2 -->
    ...
    <section id="seksi2">
        ...
        <div id="card1" class="d-flex">
            ...
            <div id="kanan">
                ...
                <p>AC</p>
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal11">Book</button>
            </div>
        </div>
    </div>
        </div>
        ...
        <div id="card1" class="d-flex">
            ...
            <div id="kanan">
                ...
                <p>Non-Smoking Room</p>
                <p>AC</p>
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal21">Book</button>
            </div>
        </div>
    </div>
        </div>
        ...
        <div id="card1" class="d-flex">
            ...
            <div id="kanan">
                ...
                <p>Non-Smoking Room</p>
                <p>AC</p>
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal22">Book</button>
            </div>
        </div>
    </div>
        </div>
        ...
        <div id="card1" class="d-flex">
            ...
            <div id="kanan">
                ...
                <p>Non-Smoking Room</p>
                <p>AC</p>
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal31">Book</button>
            </div>
        </div>
    </div>
        </div>
        ...
        <div id="card1" class="d-flex">
            ...
            <div id="kanan">
                ...
                <p>Non-Smoking Room</p>
                <p>AC</p>
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal32">Book</button>
            </div>
        </div>
    </div>
        </div>
        ...
        <div id="card1" class="d-flex">
            ...
            <div id="kanan">
                ...
                <p>Non-Smoking Room</p>
                <p>AC</p>
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal41">Book</button>
            </div>
        </div>
    </div>
        </div>
    ...
    <div class="mdl">
    <div class="modal modal fade" id="modal11" tabindex="-1" style="background-color: #FFF9ED;">
...
<div class="mdl">
    <div class="modal modal fade" id="modal21" tabindex="-1" style="background-color: #FFF9ED;">
    <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#FFF9ED;">
        <div class="container text-center">
...
<div class="mdl">
    <div class="modal modal fade" id="modal22" tabindex="-1" style="background-color: #FFF9ED;">
    <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#FFF9ED;">
        <div class="container text-center">
 ...
 <!-- MODAL 3 INDOOR  -->
 <div class="mdl">
    <div class="modal modal fade" id="modal31" tabindex="-1" style="background-color: #FFF9ED;">
    <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#FFF9ED;">
        <div class="container text-center">
...
<!-- MODAL 3 OUTDOOR -->
<div class="mdl">
    <div class="modal modal fade" id="modal32" tabindex="-1" style="background-color: #FFF9ED;">
    <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#FFF9ED;">
        <div class="container text-center">
...
<!-- Modal 4 Outdoor -->
<div class="mdl">
    <div class="modal modal fade" id="modal41" tabindex="-1" style="background-color: #FFF9ED;">
    <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#FFF9ED;">
        <div class="container text-center">
